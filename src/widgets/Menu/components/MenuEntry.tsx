...
const LinkLabel = styled.div<{ isPushed: boolean }>`
  color: ${({ isPushed, theme }) => (isPushed ? (theme.isDark ? theme.colors.textSubtle : '#c3c350') : "transparent")};
...
const MenuEntry = styled.div<Props>`
  ...
  color: ${({ theme }) => theme.isDark ? theme.colors.textSubtle : "#c3c350"};
  ...
  svg {
    fill: ${({ theme }) => theme.isDark ? theme.colors.textSubtle : '#c3c350'};
  }
